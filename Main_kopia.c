...
#define _TIMER_DELAY_MOVE_DETECTOR				16
...
*
*/
#define _TIMER_DELAY_LIGHTS_MOVEMENT			10
...
bit CanStartLedsFromDown()
{
	...
	return personDownDetected & !(stateFromDownToUp & BLOCKER_STATE_LEDS_DOWN);
}
bit CanStartLedsFromUp()
{
	return personUpDetected & !(stateFromUpToDown & BLOCKER_STATE_LEDS_UP);
}
...
void Main(void)
{
	...
	P1 = 0x02; //0000 0010 - input on pin P1.1
	P0 = 0xFF;
	P2 = 0xFF;
	P2 = 0xFF;	
	P1_0 = 0;
